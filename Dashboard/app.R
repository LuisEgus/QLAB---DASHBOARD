...
library(htmlwidgets)
library(webshot2)
#Instalar remotes por sea caso, para descargar el paquete por:
# remotes::install_github("rstudio/webshot2")
library("RColorBrewer")   #display.brewer.all()
library(DT)
library(ggplot2)

#install.packages("MASS", version = "7.3-58.3") (soluciona el último error antes de publicar)

################################################################################
#Limpieza y manejo de datos
################################################################################

#setwd("E:\2021-2\Qlab\QLAB_COV_ACT\Dashboard")
...
Sys.setlocale("LC_ALL", "es_PE")
Sys.setenv("LANGUAGE" = "Spanish")

#Fecha de actualización de datos
a = "17/08/2023"

#Fecha de inicio de recopilación de datos
b = "01/03/2020"
                                          ...
                                          fluidRow(
                                            ...
                                            column(9,
                                                   ...
                                                   p("QLAB-PUCP presenta su dashboard para analizar la evolución del Covid-19 en el Perú. 
                                                     ...
                                                     style="text-align:justify;color:black;background-color:#f8f5f0;padding:15px;border-radius:10px"),
                                            ...
                                            column(12,
                                                   ...
                                                   p(br(),tags$img(src="pucp-qlab.png",width="195px",height="80px"), style="text-align:right")   
                                                   #p(em("Desarrollado por"),br(),tags$img(src="pucp-qlab.png",width="195px",height="80px"), style="text-align:right; font-family: arial")      
                                            )
                                          )
                                 ),
                                            ...
                                            fluidRow(style= "font-size: 13px",
                                                     column(8, 
                                                            ...
                                                            p(em(strong("Sobre las variables:")), br(), br(),
                                                              ...
                                                              style="text-align:left;color:black;background-color:#f8f5f0;padding:15px;border-radius:10px")),
                                              ...
                                              fluidRow(
                                                ...
                                                column(12,style= "font-size: 14px",
                                                       ...
                                                       p("Fuente: Elaboración propia basada en MINSA y SINADEF",
                                                         style="text-align:right;color:black;background-color:white;padding:15px;border-radius:10px;font-family: arial") ),
